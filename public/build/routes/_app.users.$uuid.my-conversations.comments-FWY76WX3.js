...
// app/routes/_app.users.$uuid.my-conversations.comments.tsx
var import_node = __toESM(require_node());
var import_lodash = __toESM(require_lodash());
var import_react2 = __toESM(require_react());
var import_session = __toESM(require_session());
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
function UserMyComments() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: [
    navigation.state === "loading" && navigation.location.pathname === location.pathname ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(skeleton_default, { active: true }, void 0, false, {
      fileName: "app/routes/_app.users.$uuid.my-conversations.comments.tsx",
      lineNumber: 102,
      columnNumber: 9
...
export {
  UserMyComments as default
};
//# sourceMappingURL=/build/routes/_app.users.$uuid.my-conversations.comments-FWY76WX3.js.map
